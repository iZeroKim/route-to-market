...
class _VisitsPageState extends State<VisitsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final isLoading = visitsState is VisitsLoading || customersState is CustomersLoading || activitiesState is ActivitiesLoading || statsState is VisitStatisticsLoading;
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            StatisticsCard(),
            SizedBox(
              height: AppConstants.bigPadding,
            ),
            Text(
                    ...
                    if (state is VisitsLoading) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final dateString = date != null ? '${date.day}/${date.month}/${date.year} ${date.hour}:${date.minute.toString().padLeft(2, '0')}' : 'No date';
                          ...
                          if (customersState is CustomersLoaded) {
                            final customer = customersState.customers.firstWhere((c) => c.id == visit.customerId, orElse: () => Customer(id: visit.customerId, name: '', createdAt: DateTime.now()));
                            customerName = customer.name;
                          }

                          return InkWell(
                            onTap: (){
                              showVisitDetailsDialog(context: context, visit: visit, customerName: customerName ?? '', );
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          customerName.isNotEmpty ? customerName : 'Customer ${visit.customerId}',
